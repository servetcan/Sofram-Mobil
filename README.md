...
⚡ Custom SPA Routing:
Implemented custom Vanilla JS view switching logic (showPage, goBack) for instant, reload-free navigation between Home, Categories, Product Details, and Cart .

🛒 Persistent Shopping Cart:
Advanced cart logic utilizing localStorage to save user selections, calculate totals in real-time, and handle item quantity updates .

🔍 Real-Time Search:
Instant filtering mechanism that searches through product names and descriptions as the user types .

📦 PWA Ready: 
Includes a manifest.json file and theme colors, laying the foundation for a Progressive Web App that can be installed on a user's home screen .

🔔 Custom Toast Notifications:
Custom-built, animated toast notifications for user actions like adding items to the cart or completing a checkout .
...
Data Management:
JSON Data Fetching & Web Storage API (localStorage) 

Architecture: 
Single Page Application (SPA), Mobile-First Design 
